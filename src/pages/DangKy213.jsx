  ...
  const buildEmailHtml = (reg, member, diaDiem, thoiGian, lienHe) => {
    return `
      <div style="font-family: 'SVN-Gilroy', 'Inter', sans-serif; max-width: 650px; margin: 0 auto; color: #333; line-height: 1.6;">
        <div style="background-color: #c62828; background: linear-gradient(135deg,#c62828,#b71c1c); padding: 24px; text-align: center; border-radius: 10px 10px 0 0; font-family: inherit;">
        ...
        <div style="padding: 24px; border: 1px solid #e8e8e8; border-top: none; border-radius: 0 0 10px 10px; background: #fff; font-family: inherit;">
          <p style="font-size: 15px; margin-bottom: 6px; font-family: inherit;">Kính gửi Đồng chí <strong style="color:#c62828">${member.ho_ten || ''}</strong>,</p>
          <p style="font-size: 14px; color:#555; text-align:justify; font-family: inherit;">Giấy đăng ký theo quy định 213 về việc giữ mối liên hệ với tổ chức đảng và nhân dân nơi cư trú đã được Chi bộ Xử lý hoàn tất. Đồng chí vui lòng đến nhận giấy theo thông tin dưới đây.</p>
          ...
          <div style="background:#f6ffed; border:1px solid #b7eb8f; border-radius:8px; padding:14px 18px; margin:16px 0; font-family: inherit;">
            <p style="margin:0 0 10px 0; font-weight:700; color:#52c41a; font-size:14px; font-family: inherit;">📍 Thông tin nhận giấy</p>
            <table style="width:100%; border-collapse:collapse; font-size:13px; font-family: inherit;">
              <tr><td style="padding:4px 0; color:#8c8c8c; width:100px; font-weight:600; font-family: inherit;">Địa điểm:</td><td style="font-weight:600; color:#333; font-family: inherit;">${diaDiem}</td></tr>
              <tr><td style="padding:4px 0; color:#8c8c8c; font-weight:600; font-family: inherit;">Thời gian:</td><td style="font-weight:600; color:#333; font-family: inherit;">${thoiGian}</td></tr>
            </table>
          </div>

          <p style="font-size:14px; margin-top:16px; font-family: inherit;">Mọi thắc mắc xin vui lòng liên hệ: <strong>${lienHe}</strong>.</p>
          <p style="font-size:14px; margin-top:20px; font-weight:600; color:#555; font-family: inherit;">Trân trọng./.</p>

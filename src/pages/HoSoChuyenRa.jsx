...
const generateDefaultEmailTemplate = (record, values) => {
  ...
  <div style="background-color: #fa8c16; background: linear-gradient(135deg,#fa8c16,#d46b08); padding: 24px; text-align: center; border-radius: 10px 10px 0 0; font-family: inherit;">
  ...
  <div style="padding: 24px; border: 1px solid #e8e8e8; border-top: none; border-radius: 0 0 10px 10px; background: #fff; font-family: inherit;">
    ...
    <p style="font-size:14px; margin-top:16px; text-align:justify; font-family: inherit;">Đồng chí vui lòng chú ý điện thoại để nhận thông báo từ Đảng ủy UBND về việc nhận lại hồ sơ Đảng viên (Hồ sơ gốc) và nộp cho Đơn vị mới. Cảm ơn đồng chí đã luôn đồng hành và gắn bó cùng Chi bộ Sinh viên trong suốt thời gian vừa qua.</p>
